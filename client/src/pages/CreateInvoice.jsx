          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3.5">
                {items.map((item, idx) => (
                  <div key={idx} className="grid grid-cols-12 gap-3 items-start border border-slate-100 p-3.5 rounded-xl dark:border-slate-800 bg-slate-50/20 dark:bg-slate-800/10 relative">
                    {/* Item Name */}
                    <div className="col-span-12 sm:col-span-4">
                      <label className="block text-[9px] font-semibold text-slate-400 uppercase tracking-wider mb-1 sm:hidden">Item Name</label>
                      <input
                        type="text"
                    ...
                    <div className="col-span-12 sm:col-span-3">
                      <label className="block text-[9px] font-semibold text-slate-400 uppercase tracking-wider mb-1 sm:hidden">Description</label>
                      <input
                        type="text"
                    ...
                    <div className="col-span-3 sm:col-span-1">
                      <label className="block text-[9px] font-semibold text-slate-400 uppercase tracking-wider mb-1 sm:hidden text-center">Qty</label>
                      <input
                        type="number"
                        min="1"
                        placeholder="Qty"
                    ...
                    <div className="col-span-4 sm:col-span-2">
                      <label className="block text-[9px] font-semibold text-slate-400 uppercase tracking-wider mb-1 sm:hidden text-right">Rate</label>
                      <input
                        type="number"
                        min="0"
                        placeholder="Rate"
                    ...
                    {/* GST % */}
                    <div className="col-span-3 sm:col-span-1">
                      <label className="block text-[9px] font-semibold text-slate-400 uppercase tracking-wider mb-1 sm:hidden text-center">GST</label>
                      <select
                        value={item.taxRate}
                    ...
                    {/* Remove button */}
                    <div className="col-span-2 sm:col-span-1 flex items-center justify-end sm:h-9 self-end">
                      <button
                        type="button"
